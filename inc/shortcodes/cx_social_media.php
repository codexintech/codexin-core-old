...
// Registering Social Media Shortcode
function cx_social_media_shortcode( $atts, $content = null ) {
	...
	$error = '<i class="fa fa-exclamation-triangle" title="'. esc_html__( 'No Valid URL Found', 'codexin' ) .'"></i>';
	 						...
	 						array(
								...
								'options' 		=> array(
									array(
										...
										esc_html__( 'Icon Wrapper', 'codexin' ) => array(
 										...
 										esc_html__( 'Icons', 'codexin' ) => array(
