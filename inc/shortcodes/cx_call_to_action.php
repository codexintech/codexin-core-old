		...
		?>
		   	...
		   	<div class="<?php echo esc_attr( implode( ' ', $master_class ) ); ?>">
	   			<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	   				<?php 
	   				echo ( $icon_toggle ) ? '<i class="'. esc_attr( $icon ) .' cx-color-2"></i>' : '';
	   				echo '<div class="cta-details cx-color-2">';
	   					echo ( ! empty( $cta_title ) ) ? '<h4 class="cta-title">'. sprintf('%s', $cta_title) .'</h4>' : '';
	   					echo ( ! empty( $cta_desc ) ) ? '<p>'. sprintf('%s', $cta_desc) .'</p>' : '';
	   				echo '</div>';
	   				echo '<div class="cx-cta-btn">';
	   					echo '<a href="'. esc_url( $retrieve_link[0] ) .'" '. $title .' '. $target .'>'. esc_html( $button_text ) .'</a>';
	   				echo '</div>';
	   				?>
	    			...
	    			'params' 		=> array(
	    				...
	    				'general' 	=> array(
	    					...
	    					array(
	    						...
	    						'admin_label' 	=> true,
	    						'value'		  	=> esc_html__( 'Sample CTA Title', 'codexin' )
    						),
