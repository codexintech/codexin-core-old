			...
			<div class="row">
					...
					if( $data->have_posts() ) {
						...
						if( function_exists( 'codexin_attachment_metas_extended' ) ) {
							...
							$post_thumbnail = ( has_post_thumbnail() ) ? get_the_post_thumbnail_url( get_the_ID(), $thumbnail_size ) : '//placehold.it/480X595';
						}

						?>
						<div class="col-sm-3">
							<div class="team-single">
								<img src="<?php echo esc_url( $post_thumbnail ); ?>" alt="<?php echo esc_attr( $img_alt ); ?>" class="img-responsive" />
								<div class="team-single-wrapper">
									<div class="team-social">
										<?php
										echo ( ! empty( $fb ) ) ? '<a href="'. esc_url( $fb ) .'"><i class="fa fa-facebook"></i></a>' : '';
										echo ( ! empty( $tr ) ) ? '<a href="'. esc_url( $tr ) .'"><i class="fa fa-twitter"></i></a>' : '';
										echo ( ! empty( $ig ) ) ? '<a href="'. esc_url( $ig ) .'"><i class="fa fa-instagram"></i></a>' : '';
										echo ( ! empty( $gp ) ) ? '<a href="'. esc_url( $gp ) .'"><i class="fa fa-google-plus"></i></a>' : '';
										echo ( ! empty( $li ) ) ? '<a href="'. esc_url( $li ) .'"><i class="fa fa-linkedin"></i></a>' : '';
										?>
									</div>
								</div>
							</div>
  	        				...
  	        				array(
  	        					...
  	        					'options' 		=> array(
  	        						array(
  	        							...
  	        							esc_html__( 'Name Wrapper', 'codexin' ) => array(
